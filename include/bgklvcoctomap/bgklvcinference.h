#ifndef LA3DM_BGKLVC_H
#define LA3DM_BGKLVC_H
...
namespace la3dm {
    ...
    public:
        ...
        BGKLVCInference(T sf2, T ell) : sf2(sf2), ell(ell), trained(false) { }

        /*
         * @brief Fit BGKLVC Model
        ...
        /*
         * @brief Predict with BGKLVC Model
    ...
    typedef BGKLVCInference<3, float> BGKLVC3f;

}
#endif // LA3DM_BGKLVC_H
