#ifndef LA3DM_BGKLVC_OCTOMAP_H
#define LA3DM_BGKLVC_OCTOMAP_H
...
#include "rtree.h"
#include "bgklvcblock.h"
#include "bgklvcoctree_node.h"
#include "point6f.h"
...
namespace la3dm {
    ...
    public:
         ...
         */
        BGKLVCOctoMap(float resolution,
        ...
        /*
         * @brief Insert PCL PointCloud into BGKLVCOctoMaps.
        ...
        class RayCaster {
        public:
            RayCaster(const BGKLVCOctoMap *map, const point3f &start, const point3f &end) : map(map) {
                assert(map != nullptr);
        ...
        public:
            LeafIterator(const BGKLVCOctoMap *map) {
                assert(map != nullptr);
