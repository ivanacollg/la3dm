...
namespace la3dm {
    ...
    BGKLVCOctoMap::BGKLVCOctoMap() : BGKLVCOctoMap(0.1f, // resolution
                                        4, // block_depth
                                        1.0, // sf2
                                        1.0, // ell
                                        0.3f, // free_thresh
    ...
    BGKLVCOctoMap::BGKLVCOctoMap(float resolution,
    ...
    void BGKLVCOctoMap::set_resolution(float resolution) {
    ...
    void BGKLVCOctoMap::set_block_depth(unsigned short max_depth) {
    ...
    void BGKLVCOctoMap::insert_pointcloud(const PCLPointCloud &cloud, const point3f &origin, float ds_resolution,
...
#pragma omp parallel for
    ...
    void BGKLVCOctoMap::get_bbox(point3f &lim_min, point3f &lim_max) const {
    ...
    void BGKLVCOctoMap::downsample(const PCLPointCloud &in, PCLPointCloud &out, float ds_resolution) const {
        if (ds_resolution < 0) {
            out = in;
            return;
        }
    ...
    void BGKLVCOctoMap::bbox(const GPLineCloud &cloud, point3f &lim_min, point3f &lim_max) const {
        vector<float> x, y, z;
    ...
    void BGKLVCOctoMap::get_blocks_in_bbox(const point3f &lim_min, const point3f &lim_max,
    ...
    int BGKLVCOctoMap::get_gp_points_in_bbox(const BlockHashKey &key,
                                         vector<int> &out) {
        point3f half_size(OcTreeNode::ell, OcTreeNode::ell, OcTreeNode::ell);
    ...
    int BGKLVCOctoMap::has_gp_points_in_bbox(const BlockHashKey &key) {
        point3f half_size(OcTreeNode::ell, OcTreeNode::ell, OcTreeNode::ell);
        point3f lim_min = hash_key_to_block(key) - half_size;
        point3f lim_max = hash_key_to_block(key) + half_size;
    ...
    int BGKLVCOctoMap::get_gp_points_in_bbox(const point3f &lim_min, const point3f &lim_max,
                                         vector<int> &out) {
        float a_min[] = {lim_min.x(), lim_min.y(), lim_min.z()};
        float a_max[] = {lim_max.x(), lim_max.y(), lim_max.z()};
        return rtree.Search(a_min, a_max, BGKLVCOctoMap::search_callback, static_cast<void *>(&out));
    }

    int BGKLVCOctoMap::has_gp_points_in_bbox(const point3f &lim_min,
                                         const point3f &lim_max) {
        float a_min[] = {lim_min.x(), lim_min.y(), lim_min.z()};
        float a_max[] = {lim_max.x(), lim_max.y(), lim_max.z()};
        return rtree.Search(a_min, a_max, BGKLVCOctoMap::count_callback, NULL);
    }

    bool BGKLVCOctoMap::count_callback(int k, void *arg) {
        return false;
    }

    bool BGKLVCOctoMap::search_callback(int k, void *arg) {
    ...
    int BGKLVCOctoMap::has_gp_points_in_bbox(const ExtendedBlock &block) {
    ...
    int BGKLVCOctoMap::get_gp_points_in_bbox(const ExtendedBlock &block,
                                         vector<int> &out) {
        int n = 0;
        for (auto it = block.cbegin(); it != block.cend(); ++it) {
    ...
    Block *BGKLVCOctoMap::search(BlockHashKey key) const {
        auto block = block_arr.find(key);
        if (block == block_arr.end()) {
            return nullptr;
        } else {
    ...
    OcTreeNode BGKLVCOctoMap::search(point3f p) const {
    ...
    OcTreeNode BGKLVCOctoMap::search(float x, float y, float z) const {
