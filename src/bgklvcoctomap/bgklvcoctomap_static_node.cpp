...
int main(int argc, char **argv) {
    ros::init(argc, argv, "bgklvcoctomap_static_node");
    ros::NodeHandle nh("~");
    ...
    la3dm::BGKLVCOctoMap map(resolution, block_depth, sf2, ell, free_thresh, occupied_thresh, var_thresh, prior_A, prior_B, original_size, min_W);
